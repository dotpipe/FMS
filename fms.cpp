...
//	else
	...
	cout << "\n\tpow(((h*0.28209478784887687119),2)*pi*4 = " << pow(((h*0.28209478784887687119),2)*pi*4 << "\t\tCubic Area: " << pow(h,3) << endl;
	cout << "\t\tSphere\t\t\t\tRadius\t\t\tIntegration\t\t\tDifferential" << endl;
	float p = b;
	z = 0;
	if (pow(h,3) - pow((h*0.28209478784887687119),2)*pi*4 > 0)
		while (pow((h*0.28209478784887687119) + z,2)*pi*4 - pow(h,3) > 0)
			z += 1;
	else
		while (pow((h*0.28209478784887687119) + z,2)*pi*4 - pow(h,3) < 0)
			z -= 1;
	if (pow(h,3) - pow((h*0.28209478784887687119)+z,2)*pi*4 > 0)
		while (pow((h*0.28209478784887687119) + z,2)*pi*4 - pow(h,3) > 0)
			z -= 0.00000001;
	else
		while (pow((h*0.28209478784887687119) + z,2)*pi*4 - pow(h,3) < 0)
...
//	if (pow(h,2) - pow(((h*0.28209478784887687119)+w),2)*pi*4 > 0.0000009)
		while (pow(h,3) - pow((h*0.28209478784887687119)+w + (0.00000000001*s),2)*pi*4 > 0.00000009)
			s += 1;
//	else
		while (pow(h,3) - pow((h*0.28209478784887687119)+w + (0.00000000001*s),2)*pi*4 < 0.00000009)
			s -= 1;
	s *= 0.00000000001;
	j = 0;
//	if (pow(h,2) - pow(((h*0.28209478784887687119)+w+s),2)*pi*4 > 0.0000000009)
		while (pow(h,3) - pow(((h*0.28209478784887687119)+w+s + (0.00000000000001*j)),2)*pi*4 > 0.00000000000001)
			j += 1;
//	else
		while (pow(h,3) - pow(((h*0.28209478784887687119)+w+s + (0.00000000000001*j)),2)*pi*4 < 0.00000000000001)
			j -= 1;
	...
	j = 0;
		while (pow(h,3) - pow(((h*0.28209478784887687119)+w+s +g+ (0.000000000000000001*(j))),2)*pi*4 > 0.00000000000000001)
			j += 1;
		while (pow(h,3) - pow(((h*0.28209478784887687119)+w+s +g+ (0.000000000000000001*(j))),2)*pi*4 < 0.00000000000000001)
			j -= 1;
	...
	c = j;
	while (j > c - 20) {
		printf("%d\t%.20f\t%.20f\t%.30f\t%.30f\n",j,pow((h*0.28209478784887687119)+ w+s+g+(0.000000000000000001*(5+j)),2)*pi*4, (h*0.28209478784887687119)+w+s+g+(0.000000000000000001*(5+j)), pow(h,3) - pow((h*0.28209478784887687119)+w+s+g+(0.000000000000000001*(5+j)),2)*pi*4 - pow((h*0.28209478784887687119)+w+s+g+(0.000000000000000001*(5+j)),2)*pi*4 + pow(h,3), pow((h*0.28209478784887687119)+w+s+g+(0.000000000000000001*(5+j)),2)*pi*4 - pow(h,3));
		j--;
	}
	return 1;
}
