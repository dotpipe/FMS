...
//	else
	...
	cout << "\n\tpow((h*0.28209478784887687119)/10*h,2)*pi*4 = " << (pow((h*0.28209478784887687119)/10*h,2)*pi*4) << "\t\tCubic Area: " << pow(h,3) << endl;
	...
	if (h > 999)
		...
		c = 15;
	while (a < c) {
		while (pow(((h*0.28209478784887681568)+(b+f))/10*(h),2)*pi*4 < pow(h,3))
			f += (1*(100/pow(10,a)));
		while (pow(((h*0.28209478784887681568)+(b+f))/10*(h),2)*pi*4 > pow(h,3))
			f -= (1*(100/pow(10,a)));
		b += f;
	...
	c = j;
	while (j > c - 20) {
		printf("%d\t%.20f\t%.20f\t%.30f\t%.30f\n",j,pow(((h*0.28209478784887681568)+(b+f))/10*(h),2)*pi*4, ((h*0.28209478784887681568)+(b+f))/10*(h), pow(h,3) - pow(((h*0.28209478784887681568)+(b+f))/10*(h),2)*pi*4 - pow(((h*0.28209478784887681568)+(b+f))/10*(h),2)*pi*4 + pow(h,3), pow(((h*0.28209478784887681568)+(b+f))/10*(h),2)*pi*4 - pow(h,3));
		j--;
	}
	return 1;
}
