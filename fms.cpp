...
int main(int argc, char * argv[]) {
	...
	printf("\t\t%.20f\t%.20f\t\t%.20f\t\t%.20f\t\t%.20f\t%.20f",pow((h*0.56418957569775374239),2)*pi,(h*0.56418957569775374239),(h*0.56418957569775374239*2),2*pi*(h*0.56418957569775374239),(2*pi*(h*0.56418957569775374239))/(2*(h*0.56418957569775374239)));
	cout << "\n\n\n\tpow(h*0.56418957569775374239,2)*pi*h = " << (pow(h*0.56418957569775374239,2)*pi*h) << "\t\tCubic Area: " << pow(h,3) << endl;
	return 1;
}
