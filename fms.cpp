...
//	else
	...
	c = j;
	while (j > c - 20) {
		printf("%d\t%.20f\t%.20f\t%.30f\t%.30f\n",j,pow(((h*0.28209478784882069391)+(b+f))*sqrt(h),2)*pi*4, ((h*0.28209478784882069391)+(b+f))*sqrt(h), pow(h,3) - pow(((h*0.28209478784882069391)+(b+f))*sqrt(h),2)*pi*4 - pow(((h*0.28209478784882069391)+(b+f))*sqrt(h),2)*pi*4 + pow(h,3), pow(((h*0.28209478784882069391)+(b+f))*sqrt(h),2)*pi*4 - pow(h,3));
		j--;
	}
	return 1;
}