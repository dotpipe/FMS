...
//	else
	...
	c = j;
	while (j > c - 20) {
		printf("%d\t%.20f\t%.20f\t%.30f\t%.30f\n",j,pow((h*0.56418957569775374239)+ w+s+g+(0.000000000000000001*(5+j)),2)*pi, (h*0.56418957569775374239)+w+s+g+(0.000000000000000001*(5+j)), pow(h,2) +- pow((h*0.56418957569775374239)+w+s+g+(0.000000000000000001*(5+j)),2)*pi - pow((h*0.56418957569775374239)+w+s+g+(0.000000000000000001*(5+j)),2)*pi + pow(h,2), pow(h,2) - pow((h*0.56418957569775374239)+w+s+g+(0.000000000000000001*(5+j)),2)*pi);
		j--;
	}
	cout << "\n\tpow((h*0.28209478784795688489)*sqrt(h),2)*pi*4 = " << (pow((h*0.28209478784795688489)*sqrt(h),2)*pi*4) << "\t\tCubic Area: " << pow(h,3) << endl;
...
//	else
		c = 15;
	while (a < c) {
		while (pow(((h*0.28209478784882069391)+(b+f))*sqrt(h),2)*pi*4 < pow(h,3))
			f += (1*(100/pow(10,a)));
		while (pow(((h*0.28209478784882069391)+(b+f))*sqrt(h),2)*pi*4 > pow(h,3))
			f -= (1*(100/pow(10,a)));
		b += f;
	...
	c = j;
	while (j > c - 20) {
		printf("%d\t%.20f\t%.20f\t%.30f\t%.30f\n",j,pow(((h*0.28209478784809305374)+(b+f))*sqrt(h),2)*pi*4, ((h*0.28209478784809305374)+(b+f))*sqrt(h), pow(h,3) - pow(((h*0.28209478784809305374)+(b+f))*sqrt(h),2)*pi*4 - pow(((h*0.28209478784809305374)+(b+f))*sqrt(h),2)*pi*4 + pow(h,3), pow(h,3) - pow(((h*0.28209478784809305374)+(b+f))*sqrt(h),2)*pi*4);
		j--;
	}
	return 1;
}
