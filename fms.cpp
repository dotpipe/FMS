...
//	else
	...
	c = j;
	while (j > c - 20) {
		printf("%d\t%.20f\t%.20f\t%.30f\t%.30f\n",j,pow((h*0.56418957569775374239)+ w+s+g+(0.000000000000000001*(5+j)),2)*pi, (h*0.56418957569775374239)+w+s+g+(0.000000000000000001*(5+j)), pow((h*0.28209478784795688489)*sqrt(h),2)*pi*4, pow((h*0.56418957569775374239)+w+s+g+(0.000000000000000001*(5+j)),2)*pi - pow(h,2));
		j--;
	}
