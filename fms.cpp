...
int main(int argc, char * argv[]) {
	...
	cout << std::fixed << std::setprecision(20) << "\tpow((h * 0.56418958354775628694807945156085),2)*pi = " << pow((h*0.56418958354775628694807945156085),2)*pi << "\tSquare Area: " << pow(h,2) << endl;
	...
	cout << "\n\n\n\tpow(h*0.56418958354775628694807945156085,2)*pi*h = " << (pow(h*0.56418958354775628694807945156085,2)*pi*h) << "\t\tCubic Volume: " << (h*h*h) << endl;
        return 1;
}
